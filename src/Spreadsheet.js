...
const doc = new GoogleSpreadsheet('121RwpPqaiVdllSbw7mdV_j29u_nSiPpnePFeNvUabx4', jwt);

const docProfilePegawai = new GoogleSpreadsheet("1P4RnnVzyMZxVXapGTBYnkB_yo5ohqq9HIp4hvTYyLyA", jwt);
