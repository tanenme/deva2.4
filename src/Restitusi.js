...
class Restitusi {
  static menuGigi() {
    return (
      ...
      "3. Silahkan Upload berkas anda melalui aplikasi New PLN Sehat. " +
      "(Bila belum mempunyai aplikasi New PLN Sehat, Ketik *5*)\n\n"+
  ...
  static menuRawatInap() {
    return (
      ...
      "4. Detail Resep Obat\n" +
      "5. Silahkan Upload berkas anda melalui aplikasi New PLN Sehat. " +
      "(Bila belum mempunyai aplikasi New PLN Sehat, Ketik *5*)\n\n"+
      "Silahkan Ketik */Menu* untuk kembali ke Menu Utama"
    );
  }
